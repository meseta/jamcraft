...
scr_lib_subtype_cooking(subtype, 0.8, 35, 50, 0, 0, 75, EFFECTS.defence);
...
scr_lib_subtype_cooking(subtype, 0.5, 0, 0, 100, 0, 100, EFFECTS.daze);
var subtype = scr_lib_create_subtype(item, SUBTYPE.chopped, spr_orange, 2, PROPS.cookable | PROPS.colorant);
scr_lib_subtype_cooking(subtype, 0.8, 45, 35, 0, 0, 75, EFFECTS.sticky);
...
scr_lib_subtype_cooking(subtype, 0.8, 50, 35, 0, 0, 75, EFFECTS.healing | EFFECTS.fast | EFFECTS.multiplier);

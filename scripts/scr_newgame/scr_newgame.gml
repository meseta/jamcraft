...
scr_inv_add_item(scr_inv_new_item(ITEM.strawberry, SUBTYPE.whole, 3, 20, 100));
scr_inv_add_item(scr_inv_new_item(ITEM.raspberry, SUBTYPE.whole, 3, 20, 100));
scr_inv_add_item(scr_inv_new_item(ITEM.sugar, SUBTYPE.ingredient, 100, 20, 100));
scr_inv_add_item(scr_inv_new_item(ITEM.lemon, SUBTYPE.juice, 5, 20, 100));

repeat(36) scr_inv_add_item(scr_inv_new_item(ITEM.lemon, SUBTYPE.juice, 5, 20, 100));
scr_inv_add_item(scr_inv_new_item(ITEM.jar, SUBTYPE.equipment, 4, 60, 100));
scr_inv_add_item(scr_inv_new_item(ITEM.jar, SUBTYPE.equipment, 1, 100, 20));

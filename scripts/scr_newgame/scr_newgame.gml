...
repeat(36) scr_inv_add_item(scr_inv_new_item(ITEM.lemon, SUBTYPE.juice, 5, 20, 100, true));
scr_inv_add_item(scr_inv_new_item(ITEM.jar, SUBTYPE.equipment, 4, 60, 100, false));
scr_inv_add_item(scr_inv_new_item(ITEM.jar, SUBTYPE.equipment, 1, 100, 20, false));
